...
public class DateUtils {
	/**
	 * Date Style for Extention Year & Month
	 */
	 ...
	 * @return
	 */
	public static synchronized String getNextDateFormatDate(int addDay,
			String style) {
		Calendar cal = Calendar.getInstance();
		Date _date = getCurrentDate();
		cal.setTime(_date);
	 ...
	 */
	public static synchronized String getNextDateFormatDate(String date,
			int addDay, String style) throws ParseException {
		Calendar cal = Calendar.getInstance();
	 ...
	 * @throws ParseException
	 */
	public static synchronized String getNextYearFormatDate(String date,
			int addDay, String style) throws ParseException {
		Calendar cal = Calendar.getInstance();
		Date _date = stringToDate(date, style);
		cal.setTime(_date);
	 ...
	 * @return
	 */
	public static synchronized String getNextMonthFormatDate(int addMonth,
			String style) {
		Calendar cal = Calendar.getInstance();
		Date _date = getCurrentDate();
		cal.setTime(_date);
	 ...
	 * @return
	 */
	public static synchronized String getNextMonthFormatDate(String date,
			int addMonth, String style) throws ParseException {
		Calendar cal = Calendar.getInstance();
		Date _date = stringToDate(date, style);
		cal.setTime(_date);
		cal.add(Calendar.MONTH, addMonth);
	 ...
	 * @return
	 */
	public static String transDateFormat(String date, String fromStyle,
			String toStyle) {
	 ...
	 * @throws ParseException
	 */
	public static Long getDateSpanDay(String dateFrom, String dateTo)
			throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static String getWeekOfDate(String dt, String style)
			throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static long timeBetween(String time1, String style1, String time2,
			String style2) throws ParseException {
		SimpleDateFormat dfs1 = new SimpleDateFormat(style1);
		SimpleDateFormat dfs2 = new SimpleDateFormat(style2);
		long between = 0;

		Date date1 = dfs1.parse(time1);
		Date date2 = dfs2.parse(time2);
	 ...
	 * @throws ParseException
	 */
	public static long timeBetween(String time1, String time2, String style)
			throws ParseException {
